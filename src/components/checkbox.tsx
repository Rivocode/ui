  ...
  const box = (
    <BaseCheckbox.Root
      ...
      className={cn(
        ...
        "data-[checked]:not-data-disabled:text-surface-raised",
        "data-[indeterminate]:not-data-disabled:border-accent-text",
        "data-[indeterminate]:not-data-disabled:bg-accent-text",
        "data-[indeterminate]:not-data-disabled:text-surface-raised",
