    ...
    <Table>
      ...
      <TableBody>
        <TableRow>
          ...
          <TableCell className="text-right font-mono">R$ 12,4K</TableCell>
        </TableRow>
        <TableRow selected>
          ...
          <TableCell className="text-right font-mono">R$ 3,3K</TableCell>
        </TableRow>
        <TableRow>
          ...
          <TableCell className="text-right font-mono">R$ 8,8K</TableCell>
        </TableRow>
      </TableBody>
    </Table>
  )
