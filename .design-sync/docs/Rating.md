...
**O alvo de toque de cada estrela é sempre 44pt.** O `size` troca só o desenho. Com `allowHalf`, o toque na metade da esquerda dá a meia estrela. Não há prévia: no toque não existe pousar.
