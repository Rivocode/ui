...
Ainda não portado — escolher dentro de árvore vira folha com níveis; até lá, dois `Select` encadeados. É ausência de agora, e não decisão: a [tabela de paridade](/react-native) separa as duas.
