 ...
 * Markdown
 *
 * As docs foram escritas para um agente ler, entao elas sao markdown puro:
 * titulo, prosa, lista, codigo. O estilo mora aqui e nao dentro do texto, para
 * um mesmo arquivo servir a pagina e o endereco `.md` cru.
 * ------------------------------------------------------------------------- */
