...
| Peca                        | Onde                                        | Estado                                                              |
| --------------------------- | ------------------------------------------- | ------------------------------------------------------------------- |
| `@rivocode/ui`              | este repo, `src/`                           | **0.18.0** no npm, na tag `v0.18.0`, e igual ao `package.json`       |
| `@rivocode/ui-native`       | este repo, `native/`                        | **0.13.0** no npm, na tag `native-v0.13.0`, e igual ao manifesto dele  |
