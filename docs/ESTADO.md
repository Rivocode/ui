...
| Peca                        | Onde                                        | Estado                                                              |
| --------------------------- | ------------------------------------------- | ------------------------------------------------------------------- |
| `@rivocode/ui`              | este repo, `src/`                           | **0.16.0** no npm, na tag `v0.16.0`, e igual ao `package.json`       |
| `@rivocode/ui-native`       | este repo, `native/`                        | **0.11.0** no npm, na tag `native-v0.11.0`, e igual ao manifesto dele  |
