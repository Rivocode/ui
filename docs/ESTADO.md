...
A suite: **3024 testes em 222 arquivos, 22941 `expect`**, 0 falhas. Do nativo
sao 943 testes em 73 arquivos; do web, 2081 em 149. A home do site exibe o
...
bun run check                # 37 passos, termina nos 3024 testes
...
bun run check:testes                                # 3024 testes em 222 arquivos
